...
const en = {
  ...
  'Create Folder Failed': 'Create Folder Failed',
  ...
  'Read Files Failed': 'Read Files Failed',
  'Files Read Successfully': 'Files Read Successfully',
  'Files Read with Errors': 'Files Read with Errors',
  'List Files Failed': 'List Files Failed',
  'Directory Listed Successfully': 'Directory Listed Successfully',
  ...
  'Website Fetch Failed': 'Website Fetch Failed',
  'Website Fetched Successfully': 'Website Fetched Successfully',
  'An error occurred while executing the tool': 'An error occurred while executing the tool',
  Size: 'Size',
  Files: 'Files',
