...
const ja = {
  ...
  'Write to File Failed': 'ファイル書き込みに失敗しました',
  'File Written Successfully': 'ファイルが正常に書き込まれました',
  'Read Files Failed': 'ファイル読み込みに失敗しました',
  'Files Read Successfully': 'ファイルが正常に読み込まれました',
  'Files Read with Errors': 'ファイル読み込み（エラーあり）',
  'List Files Failed': 'ファイル一覧取得に失敗しました',
  'Directory Listed Successfully': 'ディレクトリ一覧が正常に取得されました',
  'Move File Failed': 'ファイル移動に失敗しました',
  'File Moved Successfully': 'ファイルが正常に移動されました',
  'Copy File Failed': 'ファイルコピーに失敗しました',
  'File Copied Successfully': 'ファイルが正常にコピーされました',
  'Website Fetch Failed': 'ウェブサイト取得に失敗しました',
  'Website Fetched Successfully': 'ウェブサイトが正常に取得されました',
  'An error occurred while executing the tool': 'ツール実行中にエラーが発生しました',
  Size: 'サイズ',
  Files: 'ファイル',
  'Total Lines': '総行数',
  'Content Size': 'コンテンツサイズ',
  Items: 'アイテム',
  'Max Depth': '最大深度',
  'Ignore Patterns': '無視パターン',
  From: '移動元',
  To: '移動先',
  Status: 'ステータス',
  Type: 'タイプ',
  ...
  'No content available': 'コンテンツがありません',
  'Lines {{from}}-{{to}}': '{{from}}-{{to}}行目',
  'Total Size': '総サイズ'
}
